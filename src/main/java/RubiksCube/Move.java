...
public enum Move {
    ...
    Y_PRIME("Turn cube to the right", "Y'"),
    Y("Turn cube to the left", "Y"),
    X("Turn cube upwards", "X"),
    X_PRIME("Turn cube downwards", "X'"),
    Z("Turn cube clockwise along Z axis", "Z"),
    Z_PRIME("Turn cube counterclockwise along Z axis", "Z'");
